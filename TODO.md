...
- [ ] Choose the license after confirming what can be extracted from RangerTrac.
...
No step in that demonstration may depend on RangerTrac or private credentials.
